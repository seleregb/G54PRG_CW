...
class Game(object):
    ...
    def __init__(self):
        ...
        #initalise the paddle and the ball
        self.paddle = Paddle()
        self.ball = Ball()
        ...
        #initalise the wall for building
        self.wall = Wall()
    ...
    def run(self):
        ...
        while 1:
            ...
            #call to handle the game events
            self.handleEvents()

            #call to handle the movement of the bat/ball
            self.movement()
